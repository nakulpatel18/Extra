...
import { Routes, Route, Link, Navigate, useNavigate } from 'react-router-dom';
import React, { useEffect, useState } from 'react'
    // ... (previous imports for Dashboard, Login, Register, Landing, ForgotPassword, ResetPassword)
...
const App = () => {
    ...
    return (
        <div className="app-wrapper">
            <header className="app-header">
                <h1>Expense Tracker</h1> {/* This will be centered by header's align-items */}
                <nav className="main-nav"> {/* This is the main flex container for links */}
                    {/* Group for Home, Dashboard, Admin Panel (will be centered in main-nav) */}
                    ...
                    {/* Group for Profile Icon and Logout (will be pushed to far right) */}
